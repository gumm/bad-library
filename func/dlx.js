...
const gridMeta = s => {
  ...
  const g2D = g.map(
      e => isNaN(e * 1) ? new Array(tokenCount).fill(1).map((_, i) => i + 1) :
                          [e * 1]);
...
const reduceGrid = puzString => {
   ...
   */
  const headRow =
      new Array(4 * numCells).fill('').map((_, i) => new DoX(`H${i}`));
...
[ '9..4...5...3..5......23....4.9.....8.....697..3..1...6.2......7.75..2..3....4..1.',
  '.538.........95....9......7.....8.2.6.......3.41...67...6.1.7.5.34.6...2...7..3.4',
  ...
  '79.4....3...9....22.6.7..9...8.5.....74.61.......9..58.........6.3.2.....1....6..',
  '...93....69.4..7...7.....23.21.4....9.......5....5.31.36.....8...5..8.67....16...',
  '..8......7......484.3....9...5..2...92....3...3..6..89549..8.....2.97.3.........1']
    .forEach(reduceGrid);
